...
export default function DSS() {
  ...
  useEffect(() => {
    ...
    if (ocrResults) {
      const claimantData = {
        name: ocrResults.PATTA_HOLDER_NAME?.[0] || "Not Found",
        father: ocrResults.PERSON?.[0] || "Not Found",
        village: ocrResults.PLACE_NAME?.[0] || "Not Found",
        district: ocrResults.PLACE_NAME?.[1] || "Not Found",
        state: ocrResults.PLACE_NAME?.[2] || "Not Found",
        landArea: ocrResults.LAND_AREA?.[0] || "0",
        claimStatus: ocrResults.CLAIM_STATUS?.[0] || "Pending"
      };
      ...
      fetch("http://127.0.0.1:8000/eligible-schemes", {
        ...
        .catch((err) => console.log("Error fetching DSS data:", err));
    } else {
